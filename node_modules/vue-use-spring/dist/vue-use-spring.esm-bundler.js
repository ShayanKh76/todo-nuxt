/*!
  ...
  * @license MIT
  */
import { ref, watch, onMounted, onUnmounted, unref, computed, reactive, defineComponent, onUpdated, toRaw, Fragment, getTransitionRawChildren, warn, createVNode } from 'vue';
...
function useSpring(initialValue, springConfiguration = noWobble, options = {}) {
    ...
    function animate() {
        animationId = raf(() => {
            ...
            animateValues(framesToCatchUp, currentFrameCompletion, unref(spring), realValues.value, currentValues.value, currentVelocities.value, idealValues, idealVelocities);
