(function (global, factory) {
  ...
  (global = global || self, factory(global.VueUseGesture = {}, global.vueDemi));
  ...
  function useRecognizers(handlers, config, nativeHandlers) {
    ...
    vueDemi.onMounted(controller.effect); // @ts-ignore
  ...
  function useDrag(handler, config) {
    ...
    var buildDragConfig = vueDemi.ref();
  ...
  function usePinch(handler, config) {
    ...
    var buildPinchConfig = vueDemi.ref();
  ...
  function useWheel(handler, config) {
    ...
    var buildWheelConfig = vueDemi.ref();
  ...
  function useMove(handler, config) {
    ...
    var buildMoveConfig = vueDemi.ref();
  ...
  function useHover(handler, config) {
    ...
    var buildHoverConfig = vueDemi.ref();
  ...
  function useScroll(handler, config) {
    ...
    var buildScrollConfig = vueDemi.ref();
  ...
  springConfiguration, options) {
    ...
    var realValues = isFunction(initialValue) ? vueDemi.ref(initialValue()) : vueDemi.ref(initialValue);
    var wasAnimating = false;
    var prevTime = 0;
    var accumulatedTime = 0;
    vueDemi.watch(realValues, function (_current, _old) {
      if (!wasAnimating) {
        prevTime = now();
        accumulatedTime = 0;
        animate();
    ...
    var currentValues = vueDemi.ref(current[0]);
    var currentVelocities = vueDemi.ref(current[1]); // only done to correctly infer types, they're overridden in mounted
    ...
    if (isFunction(initialValue)) {
      // @ts-ignore
      var values = vueDemi.toRefs(vueDemi.reactive(modifiableValues));
...
//# sourceMappingURL=vueusegesture.umd.development.js.map
